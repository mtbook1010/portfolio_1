...
<div class ="container">
  ...
  <h1 class="main_t">truechip</h1>
  <div class="main">
    <section>
    <img src="~/assets/img/08-min.png">
    </section>
    <section>
    <img src="~/assets/img/more-img/08-m-01-min.png" class="for-pc">
    </section>
    <section>
    <img src="~/assets/img/more-img/08-m-02-min.png" class="for-mobile">
    </section>
    </div>
  </body>
</div>
